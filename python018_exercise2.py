...
for route in routen:
    print(
        f"{route["von"]} -> {route["nach"]} ({route["distanz"]} km mit {route["zugtyp"]})"
    )
...
print(
    "Bei einem Tageslimit von 100 km benötigen wir",
    etappen,
    "Etappen für eine Strecke von",
    gesamtDistanz,
    "km",
)
...
print(
    "Für",
    etappen,
    "Etappen mit einem Tagesbudget von 85 EUR für Übernachtungen benötigen wir",
    budget,
    "EUR insgesamt",
)
